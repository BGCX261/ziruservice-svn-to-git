...
public class ImageUtils {
	...
	public static void main(String[] args) {
		ImageUtils.scale2("E:/image/3152519739161139221.jpg", "E:/image/1.jpg", 480, 360, false);// 测试OK
	}
	 ...
	 *            透明度：alpha 必须是范围 [0.0, 1.0] 之内（包含边界值）的一个浮点数字
	 */
	public final static void pressText2(String pressText, String srcImageFile, String destImageFile, String fontName, int fontStyle, Color color, int fontSize, int x, int y,
			float alpha) {
		try {
			File img = new File(srcImageFile);
			Image src = ImageIO.read(img);
