...
public class GeneralLog {
	...
	public void info(String strPath, String str) {
		logger.info(strPath + " " + str);
	}

	@SuppressWarnings("rawtypes")
	public void info(Class o, String method, String str) {
		logger.info("class :" + o + " method :" + method + " 参数  : " + str);
	}
